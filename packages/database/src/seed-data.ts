...
export const DEFAULT_SEED_ELEARNINGS: ReadonlyArray<SeedElearning> = [
    {
        ...
        description:
            "Een praktische rondleiding voor trainers en beheerders. Leer e-learnings opbouwen, controleren en publiceren en ontdek welke beheertaken bij jouw rol horen.",
        level: "JUNIOR",
        audience: "STAFF",
        sections: [
            {
                ...
                content:
                    "Cerios Academy kent drie rollen. Studenten volgen gepubliceerde e-learnings en bekijken hun voortgang. Trainers maken en beheren hun eigen leercontent. Beheerders kunnen daarnaast alle e-learnings beheren, gebruikers goedkeuren en rollen wijzigen.\n\nVia Dashboard zie je leeractiviteit, beschikbare trainingen en badges. Catalogus toont het aanbod voor jouw rol. Historie bewaart afgeronde en actieve trainingen. Als trainer of beheerder gebruik je E-learnings beheren om content te maken. Alleen beheerders zien ook Gebruikers.",
                assignment: {
                    assignmentType: "QUIZ",
    ...
    },
    {
        ...
        description:
            "Jouw introductie tot de leeromgeving. Ontdek hoe je een training kiest, je voortgang bewaart en met punten, badges en leerstreaks gemotiveerd blijft.",
        level: "JUNIOR",
        ...
        sections: [
            {
                ...
                content:
                    "Op het Dashboard zie je in een oogopslag welke e-learnings actief of afgerond zijn, hoeveel kennispunten je hebt verdiend en hoeveel trainingen voor jou beschikbaar zijn. Onder Actieve e-learnings ga je direct verder waar je gebleven was.\n\nVia Catalogus ontdek je alle gepubliceerde trainingen die bij jouw rol passen. Je kunt zoeken op onderwerp en filteren op niveau. Open een kaart om de beschrijving, geschatte duur, leerdoelen en onderdelen te bekijken voordat je begint.",
                assignment: {
                    assignmentType: "QUIZ",
            ...
            },
            {
                ...
                content:
                    "Kies Start e-learning om aan een training te beginnen. Je doorloopt de onderdelen in een vaste volgorde. Lees de uitleg rustig en beantwoord een vraag of opdracht wanneer die aanwezig is. Bij een meerkeuzevraag zie je na het beantwoorden of je keuze correct is.\n\nJe voortgang wordt per onderdeel opgeslagen. Stop je tussendoor, dan gebruik je later Ga verder om terug te keren naar je laatste positie. Na het laatste onderdeel rond je de e-learning af en verschijnt deze in Historie met je behaalde score.",
                assignment: {
                    assignmentType: "QUIZ",
